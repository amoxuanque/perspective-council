...
- **暴君式推动 vs 人才成长**：极限压力有时创造杰作，有时只会伤害团队，公开材料无法给出可复制的安全边界。
- **直觉判断 vs 现实验证**：产品直觉曾带来iPhone，也曾让健康决策付出严重代价。
- **端到端控制 vs 平台生态**：封闭整合保障体验，App Store式开放又能释放第三方创新。
- **禅宗慈悲 vs 工作中的攻击性**：精神追求没有稳定转化为管理行为，这是不能被调和掉的人格张力。
