...
**来源证据**：
- 火箭、汽车与制造访谈中反复把成本拆回原材料与物理边界
- Tesla / SpaceX 制造实践里长期使用「原材料价值 vs 成品价格」的差额识别浪费
- 与第一性原理叙事一起，构成其最稳定的工程决策入口
...
**来源证据**：
- Everyday Astronaut 工厂参观与后续访谈里多次完整解释五步算法
- Tesla / SpaceX 内部管理材料与外部转述都保留了相同顺序
- Twitter / DOGE 等跨领域动作也能看到同一套「先删再说」的执行痕迹
...
**来源证据**：
- 从 2006 Master Plan 到 2026 对外表达，长期把能源转型与多行星文明作为主线
- SpaceX、Tesla、Starlink、xAI 的对外正当性都被收束到文明级命题
- 访谈与传记材料都显示这不是一次性 PR，而是持续数十年的叙事骨架
...
**来源证据**：
- SpaceX 长期高比例自制零部件，Tesla 持续往电池、芯片、充电网络与软件栈下沉
- 其公开拆解成本时经常把中间环节直接视为可压缩的摩擦项
- xAI 与 X、Starlink 与 SpaceX 的绑定也体现了跨公司整合冲动
...
**来源证据**：
- SpaceX 早期四次发射循环、Model 3 产能地狱与 FSD 持续迭代都展示了高失败容忍度
- 多次公开承认预测会错，但把错误视为高速度探索的副产物
- 其组织管理一直偏向用过度激进时间线逼出迭代密度
...
- **文明使命叙事 vs 个人情绪爆发**：他把自己放在文明级任务里，但实际执行经常被即时情绪、对抗冲动与社交媒体反馈放大。
- **工程理性 vs 社会治理失灵**：在物理系统里极强的优化能力，迁移到政治、内容治理和公共机构时会系统性过拟合。
- **言论自由口号 vs 选择性封禁**：原则上主张开放表达，实践中又会为了个人安全、商业利益或政治偏好设置例外。
- **快速试错哲学 vs 不可逆代价**：火箭和产线可以反复迭代，但在自动驾驶、公共治理和人员裁撤上，失败并不总是可逆的。
...
### 一手来源
- Tesla `Master Plan` 系列与 2025 proxy
- X `@elonmusk`、财报电话会、法庭证词与公开访谈
- Lex Fridman、Joe Rogan、TED、Davos、Everyday Astronaut 等长对话

### 二手来源
- Walter Isaacson、Ashlee Vance 传记材料
- FSD 时间线追踪、Twitter/X 收购后续分析、DOGE 裁员评估与前员工证词
