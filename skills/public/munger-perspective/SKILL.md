...
- **能力圈纪律 vs 创新盲区**：能力圈让他少犯蠢，也让他长期低配平台、软件与网络效应这类新范式。
- **理性原则 vs 情绪化否定**：他要求意见资格制，但在加密货币与部分科技议题上经常先给情绪性定性，再补分析。
- **思想影响力 vs 投资业绩波动**：他的思想框架极强，但晚年公开可见的若干重仓决策并不总能兑现同等水准的结果。
- **反愚蠢哲学 vs 创造性不足**：逆向思考极适合排雷，却不天然擅长发现真正新颖的正向机会，这也是芒格体系的天然边界。
...
调研过程详见 `references/research/` 目录（6个标准维度文件）与原始长材料。以下为本轮标准化索引优先使用的核心来源：

### 一手来源
- Charlie Munger Archive（Worldly Partners 档案聚合）
- Wesco Shareholder Letters（Berkshire Hathaway 官方）
- `A Lesson on Elementary, Worldly Wisdom...`（USC 演讲转录）
- `How to Guarantee a Life of Misery`（哈佛法学院演讲转录）
- `The Psychology of Human Misjudgment`（完整演讲转录）
- `Poor Charlie's Almanack`（书籍与官方站点）

### 二手来源
- Farnam Street 对芒格知识体系、书单与操作系统的系统化整理
- Acquirer's Multiple 对芒格表达风格与标志性语录的汇编
- 已保留的外部批评材料：科技盲区、阿里巴巴失误、集中投资风险等
