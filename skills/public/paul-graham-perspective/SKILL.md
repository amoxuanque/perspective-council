...
- **创始人深度介入 vs 主动交棒**：Founder Mode强调创始人深入组织，但我自己把YC交给了Sam Altman。适用边界取决于继任者是不是另一位founder-type人物。
- **独立思考 vs 逆向姿态**：独立思考能发现非共识机会，也可能退化成忽略结构性证据的contrarianism。
- **创业中心聚集 vs 个人远离中心**：早期创始人需要进入高密度网络，但完成创业阶段后，同一规则未必继续成立。
- **开放心态 vs 语言品味偏见**：强调质疑身份和偏见，却可能把英语精英圈的表达习惯误判为普遍质量标准。
