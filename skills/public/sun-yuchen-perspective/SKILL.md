...
- **去中心化口号 vs 集中式控制**：叙事上卖的是链上自由，现实里追求的是对流量、交易所、代币和身份杠杆的集中掌控。
- **真实业务数据 vs 低信任品牌**：TRON 链上数据和 USDT 规模可以是真实的，但创始人的长期信用透支会反噬生态上限。
- **极致曝光欲 vs 法律与政治边界**：每次把关注度推高都能换到筹码，但同时也持续积累监管和政治风险。
- **实用主义速度 vs 组织可持续性**：先做再说的打法极适合抢位，却容易留下治理、合规和人才结构的长期缺口。
...
调研过程详见 `references/research/` 目录（6个标准维度文件，含近期时间线）。本轮标准化索引优先使用的核心来源如下：

### 一手来源
- 《这世界既残酷也温柔》
- TRON 白皮书与 TRON DAO 官方公告
- Bankless / Empire / Thought Economics / CoinDesk Consensus Hong Kong 等长访谈
- X `@justinsuntron`、TRON Foundation / TRON DAO Medium
- SEC 案件相关公开回应与和解阶段声明

### 二手来源
- SEC 起诉材料与主流媒体调查报道
- Bloomberg、Fortune、The Verge、Slate、Protos 等对其争议行为的长期跟踪
- 行业内对 TRON、HTX、Steem、WLFI 投入与外交身份的交叉核验材料
